# Generated by Powerlevel10k configuration wizard on 2024-02-16 at 03:52 CET.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 59047.
# Wizard options: nerdfont-complete + powerline, large icons, rainbow, unicode,
# slanted separators, round heads, round tails, 1 line, compact, many icons, concise,
